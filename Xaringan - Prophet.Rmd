...
To ensure proper date format and also any other visualization purposes this should be converted to a "date-time" class which can be displayed as a continuous variable.
...
# Prophet FCST - generate the prediction
...
- "m" = prophet object<br>
- "forecast" = dataframe of `predict(m, dataframe)` function<br>
